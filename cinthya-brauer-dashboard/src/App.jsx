...
async function fsSet(dados){
  const r=await fetch(DOC_URL,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({fields:{data:{stringValue:JSON.stringify(dados)}}})});
  if(!r.ok)throw new Error(`SET ${r.status}`);
}

const atletasBase=[
  {id:1,nome:"Letícia Corrêa",idade:27,esporte:"Vôlei",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:30.4,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:2,nome:"João Furtado",idade:27,esporte:"Futevôlei",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:45.8,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:3,nome:"Henrique Tarlei",idade:25,esporte:"Futevôlei",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:62.3,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:4,nome:"Guilherme Tarlei",idade:25,esporte:"Futevôlei",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:50.4,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:5,nome:"Will",idade:40,esporte:"Ciclismo",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:31.1,saltHoriz:2.38,saltUniDir:4.88,saltUniEsq:4.60,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:6,nome:"Stephanie",idade:39,esporte:"Futevôlei",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:33,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:7,nome:"Bruno",idade:41,esporte:"Corrida / Futevôlei",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:36.7,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:8,nome:"Arthur Muce",idade:12,esporte:"Futebol",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:22.8,saltHoriz:1.89,saltUniDir:4.46,saltUniEsq:5.04,saltCruzDir:4.36,saltCruzEsq:4.03,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:9,nome:"Arthur",idade:12,esporte:"Futebol",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:null,saltHoriz:2.17,saltUniDir:5.45,saltUniEsq:4.48,saltCruzDir:4.72,saltCruzEsq:3.77,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:10,nome:"Rafael Corvini",idade:16,esporte:"Futebol",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:42.4,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:11,nome:"Pedro Girardi",idade:10,esporte:"Futebol",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:26.2,saltHoriz:1.53,saltUniDir:4.45,saltUniEsq:4.15,saltCruzDir:3.56,saltCruzEsq:3.43,saltUniTriplo:null,agach:7,supino:6,remada:6,terra:10,freqEsp:null,freqReal:null}]},
  {id:12,nome:"Vitinho",idade:26,esporte:"Futevôlei",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:50.8,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:13,nome:"Leo",idade:26,esporte:"Futevôlei",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:45.2,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
  {id:14,nome:"Rafa",idade:26,esporte:"Futevôlei",frequencia:"",arquivado:false,dados:[{mes:3,ano:2026,cmj:50.8,saltHoriz:null,saltUniDir:null,saltUniEsq:null,saltCruzDir:null,saltCruzEsq:null,saltUniTriplo:null,agach:null,supino:null,remada:null,terra:null,freqEsp:null,freqReal:null}]},
];

const camposLabel={cmj:"Salto CMJ (cm)",saltHoriz:"Salto Horizontal (m)",saltUniDir:"Unilateral Direita",saltUniEsq:"Unilateral Esquerda",saltCruzDir:"Cruzado Direita",saltCruzEsq:"Cruzado Esquerda",saltUniTriplo:"Unilateral Triplo",agach:"Agachamento (kg)",terra:"Terra (kg)",supino:"Supino (kg)",remada:"Remada (kg)",freqEsp:"Freq. Esperada",freqReal:"Freq. Real"};
const dadoVazio={mes:3,ano:2026,cmj:"",saltHoriz:"",saltUniDir:"",saltUniEsq:"",saltCruzDir:"",saltCruzEsq:"",saltUniTriplo:"",agach:"",terra:"",supino:"",remada:"",freqEsp:"",freqReal:""};

const CustomTooltip=({active,payload,label})=>{
  if(!active||!payload?.length)return null;
  return(<div style={{background:"#222",border:`1px solid #2a2a2a`,borderRadius:8,padding:"8px 12px"}}>
    <p style={{color:"#fff",margin:0,fontWeight:700}}>{label}</p>
    {payload.map((p,i)=>p.value!=null&&<p key={i} style={{color:p.color,margin:"2px 0",fontSize:13}}>{p.name}: {p.value}</p>)}
  </div>);
};

function GraficoLinha({dados,campos,titulo}){
  const temDados=dados.some(d=>campos.some(c=>d[c.key]!=null));
  return(<div style={{background:CARD,borderRadius:12,padding:16,border:`1px solid ${BORDER}`}}>
    <div style={{fontWeight:700,marginBottom:10,textAlign:"center",fontSize:13}}>{titulo}</div>
    {temDados?(<ResponsiveContainer width="100%" height={170}><LineChart data={dados}>
      <CartesianGrid strokeDasharray="3 3" stroke={BORDER}/><XAxis dataKey="label" tick={{fill:GRAY,fontSize:11}}/><YAxis tick={{fill:GRAY,fontSize:11}}/>
      <Tooltip content={<CustomTooltip/>}/>{campos.length>1&&<Legend wrapperStyle={{fontSize:11}}/>}
      {campos.map(c=><Line key={c.key} type="monotone" dataKey={c.key} stroke={c.color} strokeWidth={2} dot={{fill:c.color}} name={c.label} connectNulls={false}>
        {campos.length===1&&<LabelList dataKey={c.key} position="top" style={{fill:"#fff",fontSize:11}}/>}
      </Line>)}
    </LineChart></ResponsiveContainer>):<div style={{color:GRAY,textAlign:"center",padding:30,fontSize:13}}>Sem dados</div>}
  </div>);
}
...
function GraficoBarra({dados,campos,titulo}){
  ...
  return(<div style={{background:CARD,borderRadius:12,padding:16,border:`1px solid ${BORDER}`}}>
    <div style={{fontWeight:700,marginBottom:10,textAlign:"center",fontSize:13}}>{titulo}</div>
    {temDados?(<ResponsiveContainer width="100%" height={170}><BarChart data={dados}>
      <CartesianGrid strokeDasharray="3 3" stroke={BORDER}/><XAxis dataKey="label" tick={{fill:GRAY,fontSize:11}}/><YAxis tick={{fill:GRAY,fontSize:11}}/>
      <Tooltip content={<CustomTooltip/>}/><Legend wrapperStyle={{fontSize:11}}/>
      {campos.map(c=><Bar key={c.key} dataKey={c.key} name={c.label} fill={c.color} radius={[3,3,0,0]}>
        <LabelList dataKey={c.key} position="top" style={{fill:"#fff",fontSize:10}}/>
      </Bar>)}
    </BarChart></ResponsiveContainer>):<div style={{color:GRAY,textAlign:"center",padding:30,fontSize:13}}>Sem dados</div>}
  </div>);
}
      ...
      <div style={{position:"sticky",top:0,zIndex:10,background:"#0d0d0d",borderBottom:`2px solid ${ORANGE}`,padding:"10px 16px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <svg width="40" height="32" viewBox="0 0 320 110" xmlns="http://www.w3.org/2000/svg">
            <g fill="white"><ellipse cx="62" cy="72" rx="28" ry="26"/><rect x="50" y="44" width="24" height="14" rx="4"/><path d="M54 44 Q62 28 70 44" stroke="white" strokeWidth="7" fill="none" strokeLinecap="round"/><ellipse cx="62" cy="40" rx="5" ry="4"/></g>
      ...
      <div style={{maxWidth:430,margin:"0 auto",padding:"16px 16px 40px"}}>
        ...
        {grafDefs.filter(g=>temDados(g.campos)).map((g,i)=>(
          <div key={i} style={{marginBottom:14}}>
            {g.tipo==="linha"?<GraficoLinha dados={dadosOrdenados} campos={g.campos} titulo={g.titulo}/>:<GraficoBarra dados={dadosOrdenados} campos={g.campos} titulo={g.titulo}/>}
          </div>
        ))}
...
function ModalDados({tipo,atletas,onImportar,onFechar}){
  ...
  function copiar(){try{navigator.clipboard.writeText(texto);setMsg("✅ Copiado!");}catch{setMsg("Selecione e copie manualmente (Ctrl+C).");}}
  function tentarImportar(){try{const p=JSON.parse(texto);if(!Array.isArray(p))throw new Error();setConfirmando(true);}catch{setMsg("❌ JSON inválido.");}}
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:3000,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
      <div style={{background:"#1a1a1a",borderRadius:16,padding:28,maxWidth:540,width:"100%",border:`1px solid ${BORDER}`}}>
        ...
        <div style={{color:GRAY,fontSize:13,marginBottom:14}}>{tipo==="exportar"?"Copie o conteúdo abaixo e envie:":"Cole o JSON recebido e clique em Importar:"}</div>
...
function GerenciarAtletas({atletas,onArquivar,onDesarquivar,onFechar}){
  const ativos=atletas.filter(a=>!a.arquivado);
  const arquivados=atletas.filter(a=>a.arquivado);
  const btn=(bg,color,border)=>({background:bg,color,border:`1px solid ${border}`,borderRadius:6,padding:"5px 12px",fontSize:12,fontWeight:700,cursor:"pointer"});
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:3000,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
      <div style={{background:"#1a1a1a",borderRadius:16,padding:28,maxWidth:540,width:"100%",border:`1px solid ${BORDER}`}}>
        <div style={{fontSize:18,fontWeight:700,marginBottom:4,color:"#fff"}}>⚙️ Gerenciar Atletas</div>
        <div style={{color:GRAY,fontSize:13,marginBottom:20}}>Arquive atletas inativos. Os dados são sempre preservados.</div>
        ...
        <div style={{maxHeight:200,overflowY:"auto",marginBottom:16}}>
          {ativos.map(a=>(
            <div key={a.id} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",background:"#0d0d0d",borderRadius:8,marginBottom:6,border:`1px solid ${BORDER}`}}>
              ...
              <button onClick={()=>onArquivar(a.id)} style={btn("#7f1d1d","#fca5a5","#dc2626")}>Arquivar</button>
            </div>
          ))}
        </div>
        {arquivados.length>0&&(
            ...
            <div style={{maxHeight:160,overflowY:"auto",marginBottom:16}}>
              {arquivados.map(a=>(
                <div key={a.id} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",background:"#0d0d0d",borderRadius:8,marginBottom:6,border:`1px solid #333`,opacity:0.7}}>
                  ...
                  <button onClick={()=>onDesarquivar(a.id)} style={btn("#1a3a1a","#4ade80","#16a34a")}>Reativar</button>
                </div>
              ))}
            </div>
          </>
...
export default function App(){
  ...
  const [verGerenciar,setVerGerenciar]=useState(false);
  const [statusConexao,setStatusConexao]=useState("🔄 Conectando...");

  useEffect(()=>{
    let ok=false;
    const timeout=setTimeout(()=>{if(!ok){setAtletas(atletasBase);setLoading(false);setStatusConexao("⚠️ Offline");}},8000);
    fsGet()
      .then(saved=>{
        ...
        if(saved){
          ...
          setSelId(saved.find(a=>!a.arquivado)?.id||1);
        }else{
  ...
  const atletasAtivos=useMemo(()=>atletas?.filter(a=>!a.arquivado)||[],[atletas]);

  const atleta=useMemo(()=>atletas?.find(a=>a.id===selId),[atletas,selId]);
  const dadosOrdenados=useMemo(()=>atleta?[...atleta.dados].sort((a,b)=>a.ano*100+a.mes-(b.ano*100+b.mes)).map(d=>({...d,label:mesLabel(d)})):[],[atleta]);
  ...
  function salvarAtleta(){
    ...
    const id=Date.now();
    setAtletas(prev=>[...prev,{id,...novoAtleta,idade:Number(novoAtleta.idade)||"",arquivado:false,dados:[]}]);
  ...
  function arquivarAtleta(id){
    ...
    if(selId===id){const proximo=atletasAtivos.find(a=>a.id!==id);setSelId(proximo?.id||atletasAtivos[0]?.id||1);}
  ...
  return(
    <div style={{minHeight:"100vh",background:BG,color:"#fff",fontFamily:"'Segoe UI',sans-serif"}}>
      ...
      {verGerenciar&&<GerenciarAtletas atletas={atletas} onArquivar={arquivarAtleta} onDesarquivar={desarquivarAtleta} onFechar={()=>setVerGerenciar(false)}/>}
      ...
      <div style={{background:"#0d0d0d",borderBottom:`1px solid ${BORDER}`,padding:"12px 24px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
          ...
          <button style={btn("#555")} onClick={()=>setVerGerenciar(true)}>⚙️ Gerenciar</button>
      ...
      {view==="addAtleta"&&(
        <div style={{maxWidth:480,margin:"40px auto",background:CARD,borderRadius:12,padding:32,border:`1px solid ${BORDER}`}}>
          ...
          {[["nome","Nome completo"],["idade","Idade"],["esporte","Esporte"],["frequencia","Frequência (ex: 3x/semana)"]].map(([k,lb])=>(
            <div key={k} style={{marginBottom:16}}><label style={labelStyle}>{lb}</label>
              <input style={inputStyle} value={novoAtleta[k]} onChange={e=>setNovoAtleta(p=>({...p,[k]:e.target.value}))}/></div>
          ))}
      ...
      {view==="addDado"&&(
        <div style={{maxWidth:640,margin:"40px auto",background:CARD,borderRadius:12,padding:32,border:`1px solid ${BORDER}`}}>
          ...
          <div style={{marginBottom:16}}><label style={labelStyle}>Atleta</label>
          ...
          <div style={{display:"flex",gap:12,marginBottom:16}}>
            <div style={{flex:1}}><label style={labelStyle}>Mês</label>
              <select style={inputStyle} value={novoDado.mes} onChange={e=>trocarMesForm(Number(e.target.value))}>
                {MESES.map((m,i)=><option key={i} value={i+1}>{m}</option>)}
              </select></div>
            <div style={{flex:1}}><label style={labelStyle}>Ano</label>
              <input style={inputStyle} type="number" value={novoDado.ano} onChange={e=>trocarAnoForm(Number(e.target.value))}/></div>
          </div>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
            {Object.entries(camposLabel).map(([k,lb])=>(
              <div key={k}><label style={labelStyle}>{lb}</label>
                <input style={inputStyle} type="number" step="0.01" placeholder="—" value={novoDado[k]??""} onChange={e=>setNovoDado(p=>({...p,[k]:e.target.value}))}/></div>
            ))}
          </div>
          <div style={{display:"flex",gap:12,marginTop:24}}>
